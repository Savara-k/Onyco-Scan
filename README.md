...
False negatives → Missed melanoma leading to late-stage diagnosis
False positives → Unnecessary nail matrix biopsies causing pain, dystrophy, and cost
...
Pilot dataset: 91 dermoscopic nail images Internal validation accuracy: 100% (acknowledged as proof-of-concept, not deployment-ready)
...
Example logic: If high melanoma probability + recent trauma + no documented widening → recommend short-interval follow-up instead of immediate biopsy.
